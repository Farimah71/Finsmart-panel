...
import { setLoading } from "../../../redux/reducers/settings/definition";
import { api } from "../../../api";
...
export const Definition = () => {
  ...
  const {
    ...
    getLoading,
    loading,
  } = useSelector((state) => state.definitionSlice);
  ...
  const [definitionTypeValue, setDefinitionTypeValue] = useState();
            ...
            <>
              ...
              {action.type === "delete" && (
                <div
                  ...
                  className="p-2 rounded-md bg-custom-gray-light cursor-pointer"
                  onClick={() => {
                    openModalHandler("deleteConfirm", row.id);
                  }}
                >
                  <svg
                    width="16"
          ...
          filters: [
            {
              ...
              operation: 5,
              values: [`${definitionTypeValue.value}`],
            },
            {
              property: "CompanyId",
              operation: 5,
    ...
    <>
      ...
      <div className="dark:bg-dark_custom-light-black rounded-10">
        <div className="flex flex-col gap-y-8 w-full p-6 pb-4 rounded-10 bg-white dark:bg-dark_custom-light-black">
                ...
                <MyForm initialValues={{}} classes="dark:bg-transparent">
                  <div>
                    <Field
                      ...
                      name="definitionType"
                      onChangeHandler={(value) => setDefinitionTypeValue(value)}
                      placeholder={t(
          ...
          {!getLoading && (
            <span className="text-custom-blue text-center -mt-9">
              {message}
            </span>
          )}
        </div>
